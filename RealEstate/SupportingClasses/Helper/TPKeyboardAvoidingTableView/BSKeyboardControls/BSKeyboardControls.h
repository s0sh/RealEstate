...
@property NSInteger BSKeyBoardPreviousfield, BSKeyBoardCurrentfield, BSKeyBoardNextfield;
@property BOOL isNextDirection;
/**
...
- (void)BSButtonClicked:(UIButton *)button;
