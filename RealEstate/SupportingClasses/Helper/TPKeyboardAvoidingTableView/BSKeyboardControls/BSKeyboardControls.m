...
- (void)buttonClicked:(UIButton *)button{
    if ([self.delegate respondsToSelector:@selector(BSButtonClicked:)])
    {
        [self.delegate BSButtonClicked:button];
    }
}
...
- (void)selectPreviousField
{
    ...
    if (index > 0)
    {
        ...
        _BSKeyBoardPreviousfield = (index - 1);
        _BSKeyBoardCurrentfield = index;
        _BSKeyBoardNextfield = (index + 1);
